...
import 'package:final_app/services/auth.dart';
        ...
        builder: (context,snapshot)
    {
          ...
          itemBuilder: (context,index)
      {
        return ChatRoomsTile(
          snapshot.data.docs[index].data()["chatRoomId"].toString().replaceAll("_", "")
        ...
        child: Row(
          children: [
            Container(
              ...
              child:Text("${userName.substring(0,1)}",style: mediumTextStyle()) ,),
            SizedBox(width: 8,),
